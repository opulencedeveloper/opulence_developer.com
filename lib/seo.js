...
const siteConfig = {
  defaultTitle: 'OpulenceDeveloper | Registered LLC - Software Development Company',
  titleTemplate: '%s | OpulenceDeveloper',
  defaultDescription:
    'Registered Limited Liability Company (LLC) led by CEO Amobi Victor Chukwuka, specializing in AI Application Development, Web Development, Cross-Platform Mobile App Development, and Backend Development. CAC certified. Expert in JavaScript, TypeScript, Flutter, React, Next.js, Node.js, MongoDB, and PostgreSQL.',
...
export const longTailKeywords = [
  'CAC registered software company Nigeria',
  'LLC software development company',
  'Next.js development company',
  'FullStack development company Nigeria',
  'React development company Enugu',
  ...
  'software development company available',
  'professional software development LLC',
  'CAC certified software company',
];
