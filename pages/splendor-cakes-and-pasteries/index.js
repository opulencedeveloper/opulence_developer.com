...
const products = [
  ...
  {name: "Traditional Wedding Cakes", imageUrl: "traditional-wedding-cake.jpg"},
];
          ...
          {products.map((product, index) => (
            ...
            <div  className="bg-color1 h-[550px] rounded-2xl overflow-hidden w-full relative ">
              ...
              {product.name}
               ...
               <Image src={`/images/shop/splendor-cakes-and-pasteries/${product.imageUrl}`}
               loading="eager"
               priority
               height={717}
               width={960}
               ...
               />
              <button className="absolute bottom-3 overflow-hidden rounded- right-3 left-3 h-20 ">
                <div className="flex flex-col items-center justify-center text-base h-28 w-full body relative">
                <div class="light x1"></div>{" "}
        <div class="light x2"></div> <div class="light x3"></div>{" "}
        <div class="light x4"></div> <div class="light x5"></div>{" "}
        <div class="light x6"></div> <div class="light x7"></div>{" "}
        <div class="light x8"></div> <div class="light x9"></div>
        <p className="font-semibold border-b pb-0.5 mb-0.5 border-blue-100 text-sm size1:text-base">{product.name}</p>
        <div className="flex items-center space-x-2"><p>Contact vendor</p>
        <Image
