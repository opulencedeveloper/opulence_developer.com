...
const Socials = () => {
  return (
    <div className="mt-28 mb-16">
      <div className="border border-primary2 backdrop-filter backdrop-blur-md  flex flex-col justify-center items-center space-y-4 p-6 md:space-x-5 xl:flex-row xl:space-y-0">
