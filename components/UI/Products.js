...
const Products = (props) => {
  return (
    <div className="border-primary1 border-t-2 border-opacity-50 flex justify-center pt-7 mt-5 px-5 flex-wrap md:justify-evenly md:px-12 md:space-x-10 2xl:justify-start">
